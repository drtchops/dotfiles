...
class Py3status:
    ...
    def __init__(self):
        ...
        self.actions = {
            # 'ethernet tun0': {
            #     1: [external_command, 'sudo', '/usr/sbin/service', 'openvpn', 'start'],
            #     2: [external_command, 'sudo', '/usr/sbin/service', 'openvpn', 'stop'],
            #     3: [external_command, 'sudo', '/usr/sbin/service', 'openvpn', 'restart'],
            # },
        }
